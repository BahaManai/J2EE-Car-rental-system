...
<div class="container py-5">
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <div class="action-buttons">
            <a href="/LocationDeVoitures/admin/formAjoutVoiture" class="btn btn-primary">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="action-buttons">
                                    ...
                                    <a href="/LocationDeVoitures/admin/deleteVoiture?codevoiture=<%= v.getCodeVoiture() %>" class="btn btn-danger btn-sm"
