    ...
    <div class="container py-5">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <div class="action-buttons">
                <a href="listeClients" class="btn btn-primary">
        ...
        <div class="admin-card">
            ...
            <div class="card-body" style="padding:20px">
                ...
                <form id="modification" action="update" method="post" class="row g-3">
                    <input type="hidden" name="codeClient" value="<%= client.getCodeClient() %>">
                    
                    <div class="col-md-6">
                        <label for="CIN" class="form-label">CIN :</label>
                        <input disabled type="text" id="CIN" name="CIN" class="form-control" 
